...
import { Budget, Category, Price, DateMonthYear } from "../../ldm/full";
...
export const DynamicSortingExample = () => {
    ...
    const sortOptions = [
...

        {
            ...
            sortBy: dir => [newAttributeSort(Category, dir)],
        },

        {
            ...
            sortBy: dir => [newAttributeSort(DateMonthYear, dir)],
        },
        ...
        //             dir
        //         )} order.`,
        //     sortBy: (dir) => [newAttributeAreaSort(DateMonthYear, dir)],
        // },

        {
            ...
            sortBy: dir => [newAttributeAreaSort(Category, dir)],
        },
